...
description: "Skills-only equivalent of impeccable.style /extract. Extract and consolidate reusable components, design tokens, and patterns into your design system. Identifies opportunities for systematic reuse and enriches your component library. Use for frontend and UI design tasks."
---

# Impeccable /extract

Run the original Impeccable `/extract` workflow in a skills-only environment.
