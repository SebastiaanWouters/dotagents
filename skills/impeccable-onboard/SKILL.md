...
description: "Skills-only equivalent of impeccable.style /onboard. Design or improve onboarding flows, empty states, and first-time user experiences. Helps users get started successfully and understand value quickly. Use for frontend and UI design tasks."
---

# Impeccable /onboard

Run the original Impeccable `/onboard` workflow in a skills-only environment.
