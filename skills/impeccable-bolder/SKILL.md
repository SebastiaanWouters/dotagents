...
description: "Skills-only equivalent of impeccable.style /bolder. Amplify safe or boring designs to make them more visually interesting and stimulating. Increases impact while maintaining usability. Use for frontend and UI design tasks."
---

# Impeccable /bolder

Run the original Impeccable `/bolder` workflow in a skills-only environment.
