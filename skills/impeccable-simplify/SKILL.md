...
description: "Skills-only equivalent of impeccable.style /simplify. Strip designs to their essence by removing unnecessary complexity. Great design is simple, powerful, and clean. Use for frontend and UI design tasks."
---

# Impeccable /simplify

Run the original Impeccable `/simplify` workflow in a skills-only environment.
